...
(function () {
  ...
  window.__CLAUDE_THEMES_ACTIVE = '6.29.2';
  ...
  function applyTheme(project, mode) {
    ...
    st.textContent = `
      ...
      [${THEME_ATTR}] fieldset[data-tm-version="mismatch"] { box-shadow:0 0 0 3px #c9a84c,0 0 25px #c9a84caa,0 0 50px #c9a84c55 !important;border-color:#c9a84c !important; }
      [${THEME_ATTR}] fieldset[data-tm-version="missing"] { box-shadow:0 0 0 3px #c45c4c,0 0 25px #c45c4caa,0 0 50px #c45c4c55 !important;border-color:#c45c4c !important; }
